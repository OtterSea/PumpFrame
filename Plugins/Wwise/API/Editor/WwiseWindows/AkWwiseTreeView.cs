...
public class AkWwisePickerIcons
{
	...
	protected UnityEngine.Texture2D GetTexture(string texturePath)
	{
		try
		{
			byte[] imgBytes = File.ReadAllBytes(texturePath);
	...
	public void LoadIcons()
	{
		...
		// var tempWwisePath = "Packages/PumpFrame/Plugins/Wwise/API/Editor/WwiseWindows/TreeViewIcons/";
		var pumpFramePath = Path.GetFullPath("LocalPackages/PumpFrame");
		var tempWwisePath = pumpFramePath + "/Plugins/Wwise/API/Editor/WwiseWindows/TreeViewIcons/";
