	...
	public static void Setup(UnityEditor.BuildTarget target, AkPlatformPluginActivator platformPluginActivator)
	{
		...
		else
		{
			UnityEngine.Debug.LogErrorFormat(
				...
				"WwiseUnity: These plugins used by the Wwise project are missing from the Unity project: {0}. Please check folder LocalPackages/PumpFrame/Plugins/Wwise/API/Runtime/Plugin/{1}.",
